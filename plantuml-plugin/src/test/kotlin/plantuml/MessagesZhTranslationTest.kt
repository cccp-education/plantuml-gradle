...
class MessagesZhTranslationTest {
    ...
    fun `should translate key to Chinese`(key: String) {
        val en = PlantumlMessages.get(key, "en")
        val zh = PlantumlMessages.get(key, "zh")
        assertNotEquals(en, zh, "$key should be translated to Chinese, not a copy of English")
    }
}
