...
class MessagesEsTranslationTest {
    ...
    fun `should translate key to Spanish`(key: String) {
        val en = PlantumlMessages.get(key, "en")
        val es = PlantumlMessages.get(key, "es")
        assertNotEquals(en, es, "$key should be translated to Spanish, not a copy of English")
    }
}
